    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        const res = await fetch(
          `https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(q)}&format=json&addressdetails=1&limit=5&countrycodes=ar&viewbox=-59.50,-34.00,-57.80,-35.40&bounded=1`,
